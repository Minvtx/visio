        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <span className="text-sm font-medium text-meridian-cream/80">El Sistema Operativo para Agencias</span>
                </motion.div>
                ...
                <motion.h1
                    ...
                    className="text-6xl md:text-8xl font-display font-bold mb-6 tracking-tight leading-[1.1]"
                >
                    <span className="block text-white mb-2">El Caos tiene</span>
                ...
                >
                    Deja de luchar contra la entropía.
                    <br className="hidden md:block" />
                    Unifica estrategia, creación y aprobación en una sola mente digital.
                </motion.p>
