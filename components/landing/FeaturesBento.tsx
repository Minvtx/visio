...
const features = [
    {
        title: "Clones Creativos",
        description: "Agentes entrenados en tu ADN. Replican tu voz, tu estética y tus valores con una fidelidad aterradora.",
        icon: Sparkles,
    ...
    },
    {
        ...
        description: "Desde Drive hasta Meet. Tu ecosistema conectado sin fricción.",
        icon: Zap,
    ...
    },
    {
        ...
        description: "Tus clientes ven el progreso, no el desorden. Aprobaciones en un click.",
        icon: Users,
        className: "md:col-span-1",
        color: "bg-emerald-500/10 text-emerald-500",
    },
    {
        title: "Arquitectura Temporal",
        description: "Gestiona líneas de tiempo complejas con nuestra interfaz mensual dedicada.",
        icon: Calendar,
        className: "md:col-span-2",
